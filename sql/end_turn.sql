...
BEGIN
    ...
    */
    SELECT id INTO player1_id FROM player 
        WHERE game_id=game_id AND turn=TRUE;
    ...
    */
    SELECT id INTO player2_id FROM player
        WHERE game_id=game_id AND turn=FALSE;
    ...
    */
    IF tokens = 0 THEN
        UPDATE game SET winner=player1_id WHERE game_id=game_id;
    END IF;
    ...
    */
    SELECT id INTO replaced_tile_id FROM tile WHERE game_id=game_id 
    ...
    */
    UPDATE tile SET 
        ...
        tile_type="Tile",
        game_id=game_id WHERE id=placed_extra_tile.id;
