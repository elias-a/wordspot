...
import { isStraightLine, WordLetter } from "~/db/game"
...
test("is straight line", () => {
  ...
  expect(isStraightLine(word_000_001_010)).toBe(true);
  ...
  expect(isStraightLine(word_002_001_010)).toBe(false);
  ...
  expect(isStraightLine(word_000_003_110_113)).toBe(true);
  ...
  expect(isStraightLine(word_000_003_110_111)).toBe(false);
  ...
  expect(isStraightLine(word_002_101_112)).toBe(true);
  ...
  expect(isStraightLine(word__1_10__1_11__100)).toBe(true);
  ...
  expect(isStraightLine(word__1_10__1_11__102)).toBe(false);
  ...
  expect(isStraightLine(word_000_003_110_220)).toBe(false);
});
